...
public class MapManager : SIngletonBehaviour<MapManager>
{
    ...
    Dictionary<Vector2Int, TileBase> MapTilesPos = new Dictionary<Vector2Int, TileBase>();
    Dictionary<Vector2Int, GameObject> MapTileObjectsPos = new Dictionary<Vector2Int, GameObject>();
    ...
    public void MapChange(int XSize, int YSize, Dictionary<Vector2Int, TileBase> MapTilesData)
    {
        mapWidth = XSize;
        mapHeight = YSize;
